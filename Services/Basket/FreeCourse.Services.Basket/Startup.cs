...
namespace FreeCourse.Services.Basket
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            JwtSecurityTokenHandler.DefaultInboundClaimTypeMap.Remove("sub"); //payloadda gelen sub'a dokunma deðiþtirme.
            ...
            {
                opt.Filters.Add(new AuthorizeFilter(requireAuthorizePolicy)); //mutlaka auth. olmuþ kullanýcý bekliyorum.
            });
